...
//     }
// }
// // uint8_t minimum_value(uint8_t n, uint8_t s, uint8_t e, uint8_t w)
// // {
// //     if (decision == 1)
// //     {
// //     }
...
// // {
// //     if (face == north)
// //         pot_south = Maze_Border; // don't check the cell behind
// //     else if (face == east)
// //         pot_west = Maze_Border; // don't check the cell behind
// //     else if (face == south)
// //         pot_north = Maze_Border; // don't check the cell behind
// //     else if (face == west)
// //         pot_east = Maze_Border; // don't check the cell behind
